...
BOOST_AUTO_TEST_CASE( test_int_to_sto )
{
	...
	BOOST_TEST( int_to_sto(50) == string("пятьдесят") );
	BOOST_TEST( int_to_sto(60) == string("шестьдесят") );
	BOOST_TEST( int_to_sto(70) == string("семьдесят") );
	BOOST_TEST( int_to_sto(80) == string("восемьдесят") );
	BOOST_TEST( int_to_sto(90) == string("девяносто") );
...
BOOST_AUTO_TEST_CASE( test_kilo )
{
	...
	BOOST_TEST( kilo(15) == string("пятьнадцать") );
...
BOOST_AUTO_TEST_CASE( test_sch )
{
	...
	BOOST_TEST( sch(11,"рубль","рубля","рублей") == string("одинадцать рублей") );
	BOOST_TEST( sch(13,"рубль","рубля","рублей") == string("тринадцать рублей") );
	BOOST_TEST( sch(17,"рубль","рубля","рублей") == string("семьнадцать рублей") );
